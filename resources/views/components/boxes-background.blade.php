...
<svg
    class="hidden dark:block absolute inset-0 -z-10 h-full w-full stroke-white/10 {{ $class }}" aria-hidden="true"
>
    <defs>
    ...
    <svg x="50%" y="-1" class="overflow-visible fill-gray-900/20">
